...
gulp.task('styles', function() {
	return gulp.src('page/'+syntax+'/**/*.'+syntax+'')
...
gulp.task('scripts', function() {
	return gulp.src([
		...
		'page/libs/slick/slick/slick.js',
...
if (gulpversion == 3) {
	gulp.task('watch', ['styles', 'scripts', 'browser-sync'], function() {
		gulp.watch('page/'+syntax+'/**/*.'+syntax+'', ['styles']);
		gulp.watch(['libs/**/*.js', 'page/js/common.js'], ['scripts']);
		gulp.watch('page/*.html', ['code'])
	});
...
if (gulpversion == 4) {
	gulp.task('watch', function() {
		gulp.watch('page/'+syntax+'/**/*.'+syntax+'', gulp.parallel('styles'));
		gulp.watch(['libs/**/*.js', 'page/js/common.js'], gulp.parallel('scripts'));
		gulp.watch('page/*.html', gulp.parallel('code'))
	});
